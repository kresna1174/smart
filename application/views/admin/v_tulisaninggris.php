...
<head>
  ...
  <title>Esemkita | List Berita</title>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/tulisaninggris'?>"><i class="fa fa-list"></i> List Kampung Inggris</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        List Kampung Inggris
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Blog</a></li>
        <li class="active">List Kampung Inggris</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <a class="btn btn-success btn-flat" href="<?php echo base_url().'admin/tulisaninggris/add_tulisaninggris'?>"><span class="fa fa-plus"></span> Post Tulisan</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-striped" style="font-size:13px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn" href="<?php echo base_url().'admin/tulisaninggris/get_edit/'.$tulisan_id;?>"><span class="fa fa-pencil"></span></a>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $tulisan_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url().'admin/tulisaninggris/hapus_tulisan'?>" method="post" enctype="multipart/form-data">
