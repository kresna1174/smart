...
<header class="main-header">
    ...
    <a href="<?php echo base_url().'admin/dashboard'?>" class="logo">
      ...
      <span class="logo-mini"><img src="<?php echo base_url('assets/images/esemkita.png') ?>" width="50"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="<?php echo base_url('assets/images/esemkita.png') ?>" width="50">ESEMKITA</span>
    </a>
