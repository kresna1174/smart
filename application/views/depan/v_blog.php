        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form action="<?php echo site_url('blog/search');?>" method="get">
                    <input type="text" name="keyword" placeholder="Search" class="blog-search" required style="border-radius: 10px">
                    <button type="submit" class="btn btn-warning btn-blogsearch" style="border-radius: 10px;"><i class="fa fa-search"></i></button>
                </form>
