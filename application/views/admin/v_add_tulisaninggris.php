...
<div class="wrapper">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="<?php echo base_url().'admin/tulisaninggris/add_tulisaninggris'?>"><i class="fa fa-thumb-tack"></i>Post Kampung Inggris</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Post Kampung Inggris
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Berita</a></li>
        <li class="active">Add Kampung Inggris</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Post Kampung Inggris</h3>
        </div>

		<form action="<?php echo base_url().'admin/tulisaninggris/simpan_tulisan'?>" method="post" enctype="multipart/form-data">
